...
class User extends Model implements AuthenticatableContract, CanResetPasswordContract {
	 ...
	 * @var array
	 */
	protected $fillable = ['name', 'email', 'password', 'first_name', 'last_name', 'username', 'avatar', 'gender', 'confirmation_code', 'confirmed'];
	...
	{
		return $this->belongsToMany('App\Track')->withTimestamps()->selectLang();
	}

    /**
     * Many to many relationship with radio model.
     *
     * @return \Illuminate\Database\Eloquent\Relations\BelongsToMany
     */
    public function radios()
    {
        return $this->belongsToMany('App\Radio')->withTimestamps();
    }
